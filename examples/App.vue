      ...
      <div class="space-y-4">
        ...
        <div>
          <div class="flex mb-2 items-center gap-3">
            ...
            <button type="button" class="text-xs opacity-60 text-light" @click="decryptionPassphrase = passphrase">
              Paste from above
            </button>
          </div>
          <input
        ...
        <div>
          <div class="flex mb-2 items-center gap-3">
            ...
            <button type="button" class="text-xs opacity-60 text-light" @click="secretToDecrypt = serializedSecret">
              Paste from above
            </button>
          </div>
          <textarea
